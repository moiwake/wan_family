...
#       scope
#     else
#       foreign_key = "#{parent_record.class.name.downcase}_id"

#       if parent_record && parent_record[0]
#         scope.where({foreign_key => parent_record.ids})
#       elsif parent_record
#         scope.where({foreign_key => parent_record.id})
#       end
#     end
#   end
...
#     order_default.ids.difference(set_liked_scope_ids)
#   end

#   def set_liked_scope_ids
#     order_like_class.pluck(:"#{like_class_foreign_key}")
#   end

#   def order_like_class
#     like_class.constantize.group(:"#{like_class_foreign_key}").order("count(#{like_class_foreign_key}) desc")
#   end
...
class OrderedQueryBase
  ...
  def set_liked_scope_ids
    order_like_class_record.pluck(:"#{like_class_foreign_key}")
  end
